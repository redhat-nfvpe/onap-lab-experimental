...
* `/home/tripleo/ironic-python-agent.kernel` and `/home/tripleo/ironic-python-agent.initramfs` are
  small images used by TripleO's Ironic for introspection
* `/home/tripleo/ironic-python-agent.log` is the log for building the above
* `/home/tripleo/overcloud-full.qcow2` and `/home/tripleo/overcloud-full.initrd` are the OpenStack
  installation images
* `/home/tripleo/overcloud-full.log` is the log for building the above
